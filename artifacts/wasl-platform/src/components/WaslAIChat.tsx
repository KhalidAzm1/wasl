...
const QUICK_PROMPTS = [
  ...
  { label: '🚨 بنوك عالية الخطر', text: 'ما هي البنوك المتأخرة أو عالية المخاطر؟' },
  ...
  { label: '🏦 إنشاء بنك', text: 'أريد إنشاء بنك جديد في النظام' },
  { label: '📦 أرشفة بنك', text: 'أريد أرشفة بنك' },
];
