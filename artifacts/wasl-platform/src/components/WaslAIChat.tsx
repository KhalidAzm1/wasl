...
const WELCOME: Message = {
  role: 'assistant',
  isWelcome: true,
  content: `مرحباً! أنا **نور**، مساعدتك الذكية في منصة وصل 🏦

أقدر أساعدك في:

• 📊 حالة أي بنك وتقدم التنفيذ
• ⚠️ المخاطر وبنود الإجراءات المفتوحة
• 📅 الاجتماعات القادمة وإضافة اجتماعات جديدة
• ✏️ تحديث بيانات البنوك مباشرة
• 📋 التقرير الأسبوعي الشامل

بماذا أقدر أساعدك اليوم؟`,
};

const QUICK_PROMPTS = [
  { label: '📊 ملخص المنصة', text: 'أعطني ملخصاً شاملاً لحالة جميع البنوك' },
  { label: '📋 تقرير أسبوعي', text: 'اصنعي لي تقريراً أسبوعياً كاملاً' },
  { label: '🚨 بنوك متأخرة', text: 'ما هي البنوك المتأخرة أو عالية المخاطر؟' },
  { label: '📅 اجتماعات قادمة', text: 'ما هي الاجتماعات المجدولة هذا الأسبوع؟' },
];
